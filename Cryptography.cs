...
public class Cryptography : MonoBehaviour
{
    ...
    /// <summary>
    /// Øèôðîâêà ôàéëà è çàïèñü çàøèôðîâàíîé èíôîðìàöèè â ÒÎÒ ÆÅ ôàéë
    /// </summary>
    ...
    /// <summary>
    /// Äóøèôðîâêà ôàéëà è âîçâðàò ñòðîêè(åñëè ïîñëåäíèé ïàðàìåòð = false,
    /// èíà÷å ñîçäàòüñÿ íîâûé ôàéë)
    /// </summary>
    /// <param name="pathOrFile"></param>
    /// <param name="isFullPath"></param>
    /// <returns></returns>
